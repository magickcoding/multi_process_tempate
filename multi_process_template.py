...
class TaskServer(object):
    ...
    **host_list** Tasks may have a hosts to init
    **tasks**
    ...
    **id_prefix**
        If you want your workers to register a client_id , provide
        a prefix here.  TaskServer will append an incrementing number
...
#
# Worker process/function, just use gearman worker as example
#
